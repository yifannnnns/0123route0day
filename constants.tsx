...
export const ROAD_SEGMENTS: RoadSegment[] = [
  { 
    ...
    fullIntro: '斑斓海岸段由黄避岙乡西岸沿线组成，集日落咖啡、艺术中心及高品质露营于一体。',
    length: '20.3 km',
    duration: '45 min',
    highlights: ['斑斓海岸艺术中心', '落日咖啡', '沐光海太空舱露营地', '四季青藤度假酒店', '海米木木亲子庄园', '南铂酒店', '艇好玩帆船营地'],
    mustEat: ['黄鱼咖啡', '集野咖啡', '西夏王和文饭店', '西沪渔家', '大樟树农家饭店'],
    diverseSports: ['帆船运动', '霞光骑行', '海上篮球'],
    isLocked: false
  },
