...
const CalendarScreen: React.FC<CalendarScreenProps> = ({ onEventClick }) => {
  ...
  const handleBook = (e: RoadEvent, event: React.MouseEvent) => {
        ...
        {filteredEvents.length > 0 ? (
          filteredEvents.map((event) => (
            <div 
              ...
              className="group relative bg-white rounded-[32px] overflow-hidden border border-slate-100 hover:border-primary/40 transition-all duration-300 shadow-sm hover:shadow-xl cursor-pointer"
            >
              {/* Event Image */}
